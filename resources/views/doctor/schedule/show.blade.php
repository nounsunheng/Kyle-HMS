                    ...
                    <div class="space-y-3">
                        ...
                        <div class="flex items-start">
                            ...
                            <div>
                                ...
                                <p class="font-semibold text-gray-900">{{ $schedule->duration_per_appointment }} minutes</p>
                            </div>
                        </div>
                    ...
                    <div class="space-y-3">
                        <div>
                            <div class="flex items-center justify-between mb-2">
                                ...
                                <span class="text-sm font-semibold text-gray-900">{{ $schedule->booked_appointments }}/{{ $schedule->max_appointments }}</span>
                            </div>
                        ...
                        <div class="pt-2">
                            <p class="text-sm text-gray-600">
                                <span class="font-semibold text-secondary-600">{{ $schedule->available_slots }}</span> slots still available
                            </p>
                        </div>
            ...
            @if($schedule->appointments->count() > 0)
                <div class="space-y-3">
                    @foreach($schedule->appointments->sortBy('appointment_time') as $appointment)
                        <div class="border border-gray-200 rounded-lg p-4 hover:border-secondary-500 transition duration-150">
