@props(['id' => 'deleteModal', 'title' => 'Confirm Deletion', 'message' => 'Are you sure you want to delete this item?'])
        ...
        <div x-show="show"
            ...
            <div class="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                <button type="button"
                        ...
                        class="inline-flex w-full justify-center rounded-md bg-red-600 px-4 py-2 text-sm font-semibold text-white shadow-sm hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-600 focus:ring-offset-2 sm:ml-3 sm:w-auto transition duration-150">
                    Delete
                </button>
                <button type="button"
                        @click="show = false"
